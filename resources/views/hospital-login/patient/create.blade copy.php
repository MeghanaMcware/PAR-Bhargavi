                ...
                <fieldset>
                    <div class="d-flex row m-0">
                        <div class="mb-3 col-lg-6 col-12">
                            ...
                            <input class="form-control" type="text" name="patient_id" placeholder="Enter Patient ID">
                        ...
                        <div class="mb-3 col-lg-6 col-12">
                            <label class="form-label mb-0">Any surgery(<28 Days) </label>
                                    ...
                                    <div class="mb-3 col-lg-6 col-12">
                                        ...
                                        <div class="invalid-feedback">Please enter Molecular tests result received date
                                        </div>
                                    </div>

                                    <div class="mb-3 col-lg-6 col-12">
                                        <label class="form-label mb-0">Day 1 Hemat & Biochem lab values (sheet 3)
                                        </label>
                                        <input class="form-control" type="text"
                                            name="day_1_hemat___biochem_lab_values__sheet_3"
                                            placeholder="Enter Day 1 Hemat & Biochem lab values (sheet 3)">
                                        <div class="invalid-feedback">Please enter Day 1 Hemat & Biochem lab values
                                            (sheet 3)
                                        </div>
                                    </div>
                                    ...
                                    <div class="mb-3 col-lg-6 col-12">
                                        ...
                                        <div class="invalid-feedback">Please enter Blood culture flagged positive date
                                        </div>
                                    </div>
                                    ...
                                    <div class="mb-3 col-lg-6 col-12">
                                        ...
                                        <div class="invalid-feedback">Please enter Blood culture flagged positive time
                                        </div>
                                    </div>
                                    ...
                                    <div class="mb-3 col-lg-6 col-12">
                                        ...
                                        <div class="invalid-feedback">Please enter Blood culture positive communicated
                                            at</div>
                                    </div>
                                    ...
                                    <div class="mb-3 col-lg-6 col-12">
                                        ...
                                        <div class="invalid-feedback">Please enter Rapid PCRs on blood culture results
                                        </div>
                                    </div>
                                    ...
                                    <div class="mb-3 col-lg-6 col-12">
                                        ...
                                        <div class="invalid-feedback">Please enter Antibiotics change after rapid PCR
                                        </div>
                                    </div>
                                    ...
                                    <div class="mb-3 col-lg-6 col-12">
                                        ...
                                        <div class="invalid-feedback">Please enter Other Culture growth reported on
                                        </div>
                                    </div>
                                    ...
                                    <div class="mb-3 col-lg-6 col-12">
                                        ...
                                        <div class="invalid-feedback">Please enter Sample from which culture growth
                                            reported
                                        </div>
                                    </div>
                                    ...
                                    <div class="mb-3 col-lg-6 col-12">
                                        ...
                                        <div class="invalid-feedback">Please enter Antibiotic sensitivity Sheet entry 2
                                        </div>
                                    </div>
                                    ...
                                    <div class="mb-3 col-lg-6 col-12">
                                        ...
                                        <div class="invalid-feedback">Please enter MDRO screening @admission result
                                        </div>
                                    </div>
                                    ...
                                    <div class="mb-3 col-lg-6 col-12">
                                        <label class="form-label mb-0">Day 3 hemat & Biochem lab values (sheet 3)
                                        </label>
                                        <input class="form-control" type="text"
                                            name="day_3_hemat___biochem_lab_values__sheet_3"
                                            placeholder="Enter Day 3 hemat & Biochem lab values (sheet 3)">
                                        <div class="invalid-feedback">Please enter Day 3 hemat & Biochem lab values
                                            (sheet 3)
                                        </div>
                                    </div>

                                    <div class="mb-3 col-lg-6 col-12">
                                        <label class="form-label mb-0">Day 5 hemat & Biochem lab values (sheet 3)
                                        </label>
                                        <input class="form-control" type="text"
                                            name="day_5_hemat___biochem_lab_values__sheet_3"
                                            placeholder="Enter Day 5 hemat & Biochem lab values (sheet 3)">
                                        <div class="invalid-feedback">Please enter Day 5 hemat & Biochem lab values
                                            (sheet 3)
                                        </div>
                                    </div>
                                    ...
                                    <div class="mb-3 col-lg-6 col-12">
                                        <label class="form-label mb-0">Findings of X ray worsening/better/new changes
                                        </label>
                                        <input class="form-control" type="text"
                                    ...
                                    <div class="mb-3 col-lg-6 col-12">
                                        ...
                                        <div class="invalid-feedback">Please enter Days of emperical antibiotic therapy
                                        </div>
                                    </div>
                                    ...
                                    <div class="mb-3 col-lg-6 col-12">
                                        ...
                                        <div class="invalid-feedback">Please enter Days of definitive antibiotic therapy
                                        </div>
                                    </div>
