                        ...
                        <div class="inner-card">
                            ...
                            <form class="needs-validation" novalidate onsubmit="submitForm(event)">
                                ...
                                <div class="d-flex row m-0">
                                    ...
                                    <div class="mb-3 col-lg-6 col-12">
                                        <label class="form-label" style="margin-bottom: 0px !important;">q-SOFA
                                            SCORE1</label>
                                    ...
                                    <div class="mb-3 col-lg-6 col-md-6 col-12">
                                        ...
                                        <input type="text" class="form-control" name="s_lactate"
                                    ...
                                    <div class="mb-3 col-lg-6 col-md-6 col-12">
                                        ...
                                        <input type="text" class="form-control" name="s_bilirubin"
                                            placeholder="Enter S. Bilirubin">
                                    ...
                                    <div class="mb-3 col-lg-6 col-md-6 col-12">
                                        ...
                                        <input type="text" class="form-control" name="il_6_8_10"
                                    ...
                                    <div class="mb-3 col-lg-6 col-md-6 col-12">
                                        ...
                                        <input type="text" class="form-control" name="fibrinogen"
                            ...
                            <form class="needs-validation" novalidate onsubmit="submitForm(event)">
                                <div class="d-flex row m-0">
                                    ...
                                    <div class="mb-3 col-lg-6 col-12">
                                        ...
                                        <input class="form-control" type="text" name="amikacin"
                                            placeholder="Enter AMIKACIN">
                                    ...
                                    <div class="mb-3 col-lg-6 col-12">
                                        ...
                                        <input class="form-control" type="text" name="caspofungin"
                                            placeholder="Enter CASPOFUNGIN">
                                    ...
                                    <div class="mb-3 col-lg-6 col-12">
                                        ...
                                        <input class="form-control" type="text" name="ceftazidime"
                                            placeholder="Enter CEFTAZIDIME">
                                    ...
                                    <div class="mb-3 col-lg-6 col-12">
                                        ...
                                        <input class="form-control" type="text" name="cefalothin"
                                            placeholder="Enter CEFALOTHIN">
                        ...
                        <div class="inner-card">
                            ...
                            <form class="needs-validation" novalidate onsubmit="submitForm(event)">
                                <div class="row">
                                    ...
                                    <div class="mb-3 col-lg-6 col-12">
                                        <label class="form-label mb-0">Previously ill requiring admission last 3 months
                                        </label>
                                        ...
                                        <div class="invalid-feedback">Please enter Previously ill requiring admission last 3
                                            months
                                        </div>
                                    </div>

                                    <div class="mb-3 col-lg-6 col-12">
                                        <label class="form-label mb-0">Previously received any antibiotic last 3 months
                                        </label>
                                        <input class="form-control" type="text"
                                            name="previously_received_any_antibiotic_last_3_months"
                                            placeholder="Enter Previously received any antibiotic last 3 months">
                                        <div class="invalid-feedback">Please enter Previously received any antibiotic last 3
                                            months
                                        </div>
                                    </div>

                                    <div class="mb-3 col-lg-6 col-12">
                                        <label class="form-label mb-0">Initial probable sepsis diagnosis mentioned in file
                                        </label>
                                        <input class="form-control" type="text"
                                        ...
                                        <div class="invalid-feedback">Please enter Initial probable sepsis diagnosis
                                            mentioned in
                                            file</div>
                                    </div>
                                    ...
                                    <div class="mb-3 col-lg-6 col-12">
                                        ...
                                        <div class="invalid-feedback">Please enter Direct admission here or referred here?
                                        </div>
                                    </div>
                                    ...
                                    <div class="mb-3 col-lg-6 col-12">
                                        ...
                                        <div class="invalid-feedback">Please enter Date & Time of meeting SIRS criteria
                                        </div>
                                    </div>
                                    ...
                                    <div class="mb-3 col-lg-6 col-12">
                                        <label class="form-label mb-0">Renal/Metabolic/cardiac/haematology/respiratory
                                        </label>
                                        <input class="form-control" type="text"
                                    ...
                                    <div class="mb-3 col-lg-6 col-12">
                                        ...
                                        <div class="invalid-feedback">Please enter Name other samples sent for cultures
                                        </div>
                                    </div>
                                    ...
                                    <div class="mb-3 col-lg-6 col-12">
                                        ...
                                        <div class="invalid-feedback">Please enter First dose antibiotic administered Date
                                        </div>
                                    </div>
                                    ...
                                    <div class="mb-3 col-lg-6 col-12">
                                        ...
                                        <div class="invalid-feedback">Please enter First dose antibiotic administered time
                                        </div>
                                    </div>
                                    ...
                                    <div class="mb-3 col-lg-6 col-12">
                                        ...
                                        <div class="invalid-feedback">Please enter Repeat Lactate after repeated
                                            infusion(if)</div>
                                    </div>
                                    ...
                                    <div class="mb-3 col-lg-6 col-12">
                                        ...
                                        <div class="invalid-feedback">Please enter No. of organs affected(after lab reports)
                                        </div>
                                    </div>
                                    ...
                                    <div class="mb-3 col-lg-6 col-12">
                                        <label class="form-label mb-0">Any surgery(<28 Days) </label>
                                                ...
                                                <div class="mb-3 col-lg-6 col-12">
                                                    ...
                                                    <div class="invalid-feedback">Please enter Molecular tests ordered date
                                                    </div>
                                                </div>
                                                ...
                                                <div class="mb-3 col-lg-6 col-12">
                                                    <label class="form-label mb-0">Molecular tests result received date
                                                    </label>
                                                    <input class="form-control" type="text"
                                                        name="molecular_tests_result_received_date"
                                                        placeholder="Enter Molecular tests result received date">
                                                    <div class="invalid-feedback">Please enter Molecular tests result
                                                        received date
                                                    </div>
                                                </div>

                                                <div class="mb-3 col-lg-6 col-12">
                                                    <label class="form-label mb-0">Day 1 Hemat & Biochem lab values (sheet
                                                        3)
                                                    </label>
                                                    <input class="form-control" type="text"
                                                        name="day_1_hemat___biochem_lab_values__sheet_3"
                                                        placeholder="Enter Day 1 Hemat & Biochem lab values (sheet 3)">
                                                    <div class="invalid-feedback">Please enter Day 1 Hemat & Biochem lab
                                                        values
                                                        (sheet 3)
                                                    </div>
                                                </div>
                                                ...
                                                <div class="mb-3 col-lg-6 col-12">
                                                    <label class="form-label mb-0">Blood culture flagged positive date
                                                    </label>
                                                    <input class="form-control" type="text"
                                                        name="blood_culture_flagged_positive_date"
                                                        placeholder="Enter Blood culture flagged positive date">
                                                    <div class="invalid-feedback">Please enter Blood culture flagged
                                                        positive date
                                                    </div>
                                                </div>

                                                <div class="mb-3 col-lg-6 col-12">
                                                    <label class="form-label mb-0">Blood culture flagged positive time
                                                    </label>
                                                    <input class="form-control" type="text"
                                                ...
                                                <div class="mb-3 col-lg-6 col-12">
                                                    <label class="form-label mb-0">Blood culture positive communicated at
                                                    </label>
                                                    <input class="form-control" type="text"
                                                        name="blood_culture_positive_communicated_at"
                                                        placeholder="Enter Blood culture positive communicated at">
                                                    <div class="invalid-feedback">Please enter Blood culture positive
                                                        communicated
                                                        at</div>
                                                </div>

                                                <div class="mb-3 col-lg-6 col-12">
                                                    <label class="form-label mb-0">Rapid PCRs on blood culture results
                                                    </label>
                                                    <input class="form-control" type="text"
                                                        name="rapid_pcrs_on_blood_culture_results"
                                                        placeholder="Enter Rapid PCRs on blood culture results">
                                                    <div class="invalid-feedback">Please enter Rapid PCRs on blood culture
                                                        results
                                                    </div>
                                                </div>

                                                <div class="mb-3 col-lg-6 col-12">
                                                    <label class="form-label mb-0">Antibiotics change after rapid PCR
                                                    </label>
                                                    <input class="form-control" type="text"
                                                        name="antibiotics_change_after_rapid_pcr"
                                                        placeholder="Enter Antibiotics change after rapid PCR">
                                                    <div class="invalid-feedback">Please enter Antibiotics change after
                                                        rapid PCR
                                                    </div>
                                                </div>
                                                ...
                                                <div class="mb-3 col-lg-6 col-12">
                                                    ...
                                                    <div class="invalid-feedback">Please enter Other Culture growth reported
                                                        on
                                                    </div>
                                                </div>

                                                <div class="mb-3 col-lg-6 col-12">
                                                    <label class="form-label mb-0">Sample from which culture growth reported
                                                    </label>
                                                    <input class="form-control" type="text"
                                                        name="sample_from_which_culture_growth_reported"
                                                        placeholder="Enter Sample from which culture growth reported">
                                                    <div class="invalid-feedback">Please enter Sample from which culture
                                                        growth
                                                        reported
                                                    </div>
                                                </div>
                                                ...
                                                <div class="mb-3 col-lg-6 col-12">
                                                    <label class="form-label mb-0">Antibiotic sensitivity Sheet entry 2
                                                    </label>
                                                    <input class="form-control" type="text"
                                                        name="antibiotic_sensitivity_sheet_entry_2"
                                                        placeholder="Enter Antibiotic sensitivity Sheet entry 2">
                                                    <div class="invalid-feedback">Please enter Antibiotic sensitivity Sheet
                                                        entry 2
                                                    </div>
                                                </div>
                                                ...
                                                <div class="mb-3 col-lg-6 col-12">
                                                    ...
                                                    <div class="invalid-feedback">Please enter First USG abdomen done on
                                                    </div>
                                                </div>
                                                ...
                                                <div class="mb-3 col-lg-6 col-12">
                                                    ...
                                                    <div class="invalid-feedback">Please enter First Chest-X-ray done on
                                                    </div>
                                                </div>
                                                ...
                                                <div class="mb-3 col-lg-6 col-12">
                                                    <label class="form-label mb-0">Day 3 hemat & Biochem lab values (sheet
                                                        3)
                                                    </label>
                                                    <input class="form-control" type="text"
                                                        name="day_3_hemat___biochem_lab_values__sheet_3"
                                                        placeholder="Enter Day 3 hemat & Biochem lab values (sheet 3)">
                                                    <div class="invalid-feedback">Please enter Day 3 hemat & Biochem lab
                                                        values
                                                        (sheet 3)
                                                    </div>
                                                </div>
                                                ...
                                                <div class="mb-3 col-lg-6 col-12">
                                                    <label class="form-label mb-0">Day 5 hemat & Biochem lab values (sheet
                                                        3)
                                                    </label>
                                                    <input class="form-control" type="text"
                                                        name="day_5_hemat___biochem_lab_values__sheet_3"
                                                        placeholder="Enter Day 5 hemat & Biochem lab values (sheet 3)">
                                                    <div class="invalid-feedback">Please enter Day 5 hemat & Biochem lab
                                                        values
                                                        (sheet 3)
                                                    </div>
                                                </div>
                                                ...
                                                <div class="mb-3 col-lg-6 col-12">
                                                    ...
                                                    <div class="invalid-feedback">Please enter Repeat date/s of chest ray
                                                    </div>
                                                </div>
                                                ...
                                                <div class="mb-3 col-lg-6 col-12">
                                                    ...
                                                    <div class="invalid-feedback">Please enter Findings of X ray
                                                ...
                                                <div class="mb-3 col-lg-6 col-12">
                                                    ...
                                                    <div class="invalid-feedback">Please enter Pleural Tapping(if done) date
                                                    </div>
                                                </div>
                                                ...
                                                <div class="mb-3 col-lg-6 col-12">
                                                    ...
                                                    <div class="invalid-feedback">Please enter Pleural fluid culture results
                                                    </div>
                                                </div>
                                                ...
                                                <div class="mb-3 col-lg-6 col-12">
                                                    ...
                                                    <div class="invalid-feedback">Please enter Day of change of antibiotics
                                                    </div>
                                                </div>
                                                ...
                                                <div class="mb-3 col-lg-6 col-12">
                                                    <label class="form-label mb-0">Days of emperical antibiotic therapy
                                                    </label>
                                                    <input class="form-control" type="text"
                                                        name="days_of_emperical_antibiotic_therapy"
                                                        placeholder="Enter Days of emperical antibiotic therapy">
                                                    <div class="invalid-feedback">Please enter Days of emperical antibiotic
                                                        therapy
                                                    </div>
                                                </div>

                                                <div class="mb-3 col-lg-6 col-12">
                                                    <label class="form-label mb-0">Days of definitive antibiotic therapy
                                                    </label>
                                                    <input class="form-control" type="text"
                                                        name="days_of_definitive_antibiotic_therapy"
                                                        placeholder="Enter Days of definitive antibiotic therapy">
                                                    <div class="invalid-feedback">Please enter Days of definitive antibiotic
                                                        therapy
                                                    </div>
                                                </div>
                                                ...
                                                <div class="mb-3 col-lg-6 col-12">
                                                    ...
                                                    <div class="invalid-feedback">Please enter Patient outcome at 7th day
                                                    </div>
                                                </div>
                                                ...
                                                <div class="mb-3 col-lg-6 col-12">
                                                    ...
                                                    <div class="invalid-feedback">Please enter Patient outcome at 14th day
                                                    </div>
                                                </div>
                                            ...
                                            Any Comorbidity <5 years </label>
                                                ...
                                                <div class="col-lg-6 col-12">
                                                  ...
                                                  <div class="mb-3 col-lg-6 col-12">
                                                    ...
                                                    <input class="form-control" type="text" name="blood_culture_fagged_positive_date_time"
                                                 ...
                                                 <div class="col-lg-6 col-12">
                                                  ...
                                                  <div class="mb-3 col-lg-6 col-12">
                                                    ...
                                                    <div class="invalid-feedback">
                                                        Please enter Biofire report(name of pathogen, genes, reported date and time)
                                                    </div>
                                                </div>
                                                 ...
                                                 <div class="col-lg-6 col-12">
                                                    <div class="mb-3">
                                                        <label class="col-form-label mb-0">If growth on 3rd day, What is growing in Blood culture</label>
                                                        <select class="js-example-placeholder-multiple col-sm-12"
                                                            multiple="multiple">
                                                 ...
                                                 <div class="col-lg-6 col-12">
                                                    <div class="mb-3">
                                                        <label class="col-form-label mb-0">If growth in other cultures, what organism?</label>
                                                        <select class="js-example-placeholder-multiple col-sm-12"
                                                            multiple="multiple">
                                                            <option value="AL">E.coli</option>
                                                            <option value="WY">Klebsiella pneumoniae</option>
