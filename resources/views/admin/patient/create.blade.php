                            ...
                            <div class="patient-card">
                                ...
                                <div class="card-body pt-3 pb-3">
                                    <div class="row mb-3 pt-3 pb-3">
                                        ...
                                        <div class="col-md-4 col-12 mb-3">
                                            <label class="form-label mb-0">Time of Presentation</label>
                                            <input class="form-control" type="time" value="10-06-2026"
                                                name="time_presentation" placeholder="Enter time of presentation">
                                        ...
                                        <div class="col-md-4 col-12 mb-3">
                                            <label class="form-label mb-0">Age</label>
                                            <input class="form-control" type="text" value="20" name="age"
                                        ...
                                        <div class="col-md-4 col-12 mb-3">
                                            ...
                                            <input class="form-control" type="text" name="qSOFAScore"
                                                placeholder="Enter qSOFA Score">
                                        ...
                                        <div class="col-md-4 col-12 mb-3">
                                            ...
                                            <input class="form-control" type="text" name="MEWSScore"
                                                placeholder="Enter MEWS Score">
                                        ...
                                        <div class="col-md-4 col-12 mb-3">
                                            ...
                                            <input class="form-control" type="date" name="MDROScreening"
                                                placeholder="dd-mm-yyyy">
                                        ...
                                        <div>
                                            <div class="row">
                                                ...
                                                <div class="mb-3 col-md-4 col-12">
                                                    ...
                                                    <input class="form-control" id="" type="number" name="wbc_tc"
                                                ...
                                                <div class="mb-3 col-md-4 col-12">
                                                    ...
                                                    <input class="form-control" id="f1-last-name" type="text"
                                                        name="bands_left_shift" placeholder="Enter BANDS/Left shift">
                                                ...
                                                <div class="mb-3 col-md-4 col-12">
                                                    ...
                                                    <input class="form-control" id="" type="number" name="nlr"
                                                        placeholder="Enter NLR">
                                                ...
                                                <div class="mb-3 col-md-4 col-12">
                                                    ...
                                                    <input class="form-control" id="f1-last-name" type="number"
                                                        name="platelets" placeholder="Enter Platelets">
                                                ...
                                                <div class="mb-3 col-md-4 col-12">
                                                    ...
                                                    <input type="number" class="form-control" name="pc02"
                                                        placeholder="Enter PC02">
                                                    <div class="invalid-feedback">Please enter PC02</div>
                                                </div>
                                                <div class="mb-3 col-md-4 col-12">
                                                    <label class="form-label mb-0">PO2 </label>
                                                    <input type="number" class="form-control" name="po2"
                                                        placeholder="Enter PO2">
                                                    <div class="invalid-feedback">Please enter PO2</div>
                                                </div>
                                                <div class="mb-3 col-md-4 col-12">
                                                    <label class="form-label mb-0">HCO3 </label>
                                                    <input type="number" class="form-control" name="hco3"
                                                ...
                                                <div class="mb-3 col-md-4 col-12">
                                                    ...
                                                    <input type="number" class="form-control" name="aptt"
                                                ...
                                                <div class="mb-3 col-md-4 col-12">
                                                    ...
                                                    <input type="number" class="form-control" name="electrolytes"
                                                        placeholder="Enter Electrolytes">
                                                    <div class="invalid-feedback">Please enter Electrolytes</div>
                                                </div>
                                                <div class="mb-3 col-md-4 col-12">
                                                    <label class="form-label mb-0">Na</label>
                                                    <input type="number" class="form-control" name="na"
                                                ...
                                                <div class="mb-3 col-md-4 col-12">
                                                    ...
                                                    <input type="number" class="form-control" name="cl"
                                                        placeholder="Enter Cl">
                                                    <div class="invalid-feedback">Please enter Cl</div>
                                                </div>
                                                <div class="mb-3 col-md-4 col-12">
                                                    <label class="form-label mb-0">Bicarbonates</label>
                                                    <input type="number" class="form-control" name="bicarbonates"
                                                        placeholder="Enter Bicarbonates">
                                                ...
                                                <table class="table table-bordered table-striped">
                                                    <thead class="table-dark1">
                                                        <tr>
                                                            ...
                                                            <th class="text-white">Lab Parameters</th>
                                                            <th class="text-white">WBC TC</th>
                                                            <th class="text-white">BANDS/Left shift</th>
                                                            <th class="text-white">NLR</th>
                                                            <th class="text-white">Platelets</th>
                                                            <th class="text-white">Hb</th>
                                                            <th class="text-white">PCT</th>
                                                            <th class="text-white">CRP</th>
                                                            <th class="text-white">S.lactate</th>
                                                            <th class="text-white">Urea/BUN</th>
                                                            <th class="text-white">S. creatinine</th>
                                                            <th class="text-white">AST</th>
                                                            <th class="text-white">ALT</th>
                                                            <th class="text-white">S.bilurubin</th>
                                                            <th class="text-white">Albubin</th>
                                                            <th class="text-white">LDH</th>
                                                            <th class="text-white">IL 6/8/10</th>
                                                            <th class="text-white">ABG</th>
                                                            <th class="text-white">pH</th>
                                                            <th class="text-white">PC02</th>
                                                            <th class="text-white">PO2</th>
                                                            <th class="text-white">HCO3</th>
                                                            <th class="text-white">Coagulation profile</th>
                                                            <th class="text-white">APTT</th>
                                                            <th class="text-white">PT</th>
                                                            <th class="text-white">INR</th>
                                                            <th class="text-white">d-Dimer</th>
                                                            <th class="text-white">fibrinogen</th>
                                                            <th class="text-white">Electrolytes</th>
                                                            <th class="text-white">Na</th>
                                                            <th class="text-white">K</th>
                                                            <th class="text-white">Cl</th>
                                                            <th class="text-white">Bicarbonates</th>
                                                            <th class="text-white">HbA1C</th>
                                                            <th class="text-white">SpO2</th>
                                                            <th class="text-white">Actions</th>
                                                        </tr>
                                                    </thead>
                                                    <tbody id="serialLabTableBody">
                                                    </tbody>
                                                </table>
                                            </div>
                                        </div>
                                                    ...
                                                    <table class="table table-bordered table-striped">
                                                        <thead class="table-dark1">
                                                            <tr>
                                                                ...
                                                                <th class="text-white">Testing Date</th>
                                                                <th class="text-white">Organism Name</th>
                                                                <th class="text-white">AMIKACIN</th>
                                                                <th class="text-white">AMOX CLAV</th>
                                                                <th class="text-white">CEFEPIME</th>
                                                                <th class="text-white">CEFIXIME</th>
                                                                <th class="text-white">CEF + SALBACTAM</th>
                                                                <th class="text-white">CEFOXITIN</th>
                                                                <th class="text-white">CEFTRIXONE</th>
                                                                <th class="text-white">CIPROFLOXACIN</th>
                                                                <th class="text-white">COLISTIN</th>
                                                                <th class="text-white">ERTAPENEM</th>
                                                                <th class="text-white">FOSFOMYCIN</th>
                                                                <th class="text-white">MEROPENEM</th>
                                                                <th class="text-white">NITROFURURANTOIN</th>
                                                                <th class="text-white">NORFLOXACIN</th>
                                                                <th class="text-white">PIP-TAZ</th>
                                                                <th class="text-white">COTRIMAXAZOLE</th>
                                                                <th class="text-white">Actions</th>
                                                            </tr>
                                                        </thead>
                                                        <tbody id="pusCultureTableBody">
                                                        </tbody>
                                                    </table>
                                                </div>
                                            </div>
                                        ...
                                        <div id="urineCultureTableContainer" class="mt-4" style="display: none;">
                                            ...
                                            <div class="table-responsive">
                                                <table class="table table-bordered table-striped">
                                                    ...
                                                    <tbody id="urineCultureTableBody">
                                                    </tbody>
                                                </table>
                                            </div>
                                        </div>
                                            ...
                                            <div class="table-responsive">
                                                <table class="table table-bordered table-striped">
                                                    <thead class="table-dark1">
                                                        <tr>
                                                            <th class="text-white">Day</th>
                                                            <th class="text-white">Specimen Type</th>
                                                            <th class="text-white">UHID</th>
                                                            <th class="text-white">Testing Date</th>
                                                            <th class="text-white">Organism Name</th>
                                                            <th class="text-white">AMOX CLAV</th>
                                                            <th class="text-white">PIP-TAZ</th>
                                                            <th class="text-white">CEFUROXIME</th>
                                                            <th class="text-white">CEFUROXIME-AXE</th>
                                                            <th class="text-white">CEFTRIAXONE</th>
                                                            <th class="text-white">CEF-SALBACTAM</th>
                                                            <th class="text-white">CEFEPIME</th>
                                                            <th class="text-white">ERTAPENEM</th>
                                                            <th class="text-white">IMIPENEM</th>
                                                            <th class="text-white">AMIKACIN</th>
                                                            <th class="text-white">GENTAMYCIN</th>
                                                            <th class="text-white">CIPROFLOXACIN</th>
                                                            <th class="text-white">TIGECYCLINE</th>
                                                            <th class="text-white">FOSFOMYCIN</th>
                                                            <th class="text-white">COLISTIN</th>
                                                            <th class="text-white">COTRIMAXAZOLE</th>
                                                            <th class="text-white">Actions</th>
                                                    ...
                                                    <tbody id="bloodCultureTableBody">
                                                    </tbody>
                                                </table>
                                            </div>
                                        </div>
...
@section('script')
    ...
    <script>
        ...
        let pusCultureRowCount = 0;
        let urineCultureRowCount = 0;
        let bloodCultureRowCount = 0;
        ...
        function addPusCultureData() {
            ...
            let rowHtml = '<tr data-row-id="' + pusCultureRowCount + '">';
            let hasData = false;
            ...
            rowHtml += `<td class="d-flex flex-row gap-2">
                    <button type="button" class="btn btn-sm btn-info me-1" onclick="editPusCultureRow(${pusCultureRowCount})">
                        <i class="fa fa-edit"></i>
                    </button>
                    <button type="button" class="btn btn-sm btn-danger" onclick="deletePusCultureRow(${pusCultureRowCount})">
                        <i class="fa fa-trash"></i>
                    </button>
                </td>`;
            rowHtml += '</tr>';
        ...
        function addUrineCultureData() {
            ...
            let rowHtml = '<tr data-row-id="' + urineCultureRowCount + '">';
            let hasData = false;
            ...
            rowHtml += `<td class="d-flex flex-row gap-2">
                    <button type="button" class="btn btn-sm btn-info me-1" onclick="editUrineCultureRow(${urineCultureRowCount})">
                        <i class="fa fa-edit"></i>
                    </button>
                    <button type="button" class="btn btn-sm btn-danger" onclick="deleteUrineCultureRow(${urineCultureRowCount})">
                        <i class="fa fa-trash"></i>
                    </button>
                </td>`;
            rowHtml += '</tr>';
        ...
        function addBloodCultureData() {
            ...
            let rowHtml = '<tr data-row-id="' + bloodCultureRowCount + '">';
            let hasData = false;
            ...
            rowHtml += `<td class="d-flex flex-row gap-2">
                    <button type="button" class="btn btn-sm btn-info me-1" onclick="editBloodCultureRow(${bloodCultureRowCount})">
                        <i class="fa fa-edit"></i>
                    </button>
                    <button type="button" class="btn btn-sm btn-danger" onclick="deleteBloodCultureRow(${bloodCultureRowCount})">
                        <i class="fa fa-trash"></i>
                    </button>
                </td>`;
            rowHtml += '</tr>';
