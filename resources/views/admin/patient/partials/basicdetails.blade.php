         ...
         <div class="row">
             ...
             <div class="mb-3 col-lg-4 col-12">
                 ...
                 <input class="form-control" type="time" name="time_of_presentation"
                     value="{{ old('time_of_presentation', $patient->time_of_presentation ?? '') }}"
             ...
             <div class="mb-3 col-lg-4 col-12">
                 ...
                 <textarea class="form-control" name="chief_complaints" placeholder="Enter chief complaints">{{ old('chief_complaints', $patient->chief_complaints ?? '') }}</textarea>
                 <div class="invalid-feedback">
                     Please enter age.
                 </div>
             </div>
             ...
             <div class="mb-3 col-lg-4 col-12">
                 <label class="form-label mb-0">Any comorbidity (<5 years)</label>
                         <input class="form-control" type="text" name="comorbidity_less_5_years"
                             value="{{ old('comorbidity_less_5_years', $patient->comorbidity_less_5_years ?? '') }}"
                         ...
                         <div class="mb-3 col-lg-4 col-12">
                             ...
                             <input class="form-control" type="text" name="previously_ill_last_3_months"
                                 value="{{ old('previously_ill_last_3_months', $patient->previously_ill_last_3_months ?? '') }}"
                         ...
                         <div class="mb-3 col-lg-4 col-12">
                             ...
                             <input class="form-control" type="text" name="prev_antibiotic_last_3_months"
                                 value="{{ old('prev_antibiotic_last_3_months', $patient->prev_antibiotic_last_3_months ?? '') }}"
                         ...
                         <div class="mb-3 col-lg-4 col-12">
                             ...
                             <input class="form-control" type="text" name="initial_probable_sepsis_diagnosis"
                                 value="{{ old('initial_probable_sepsis_diagnosis', $patient->initial_probable_sepsis_diagnosis ?? '') }}"
                         ...
                         <div class="mb-3 col-lg-4 col-12">
                             ...
                             <input class="form-control" type="text" name="direct_or_referred"
                                 value="{{ old('direct_or_referred', $patient->direct_or_referred ?? '') }}"
             ...
             <div class="text-end">
                 ...
                 <button type="submit" class="btn btn-success me-2" name="save_progress" value="true"><i
                         class="fa fa-save"></i> Save Progress</button>
