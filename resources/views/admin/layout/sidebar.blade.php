        ...
        <nav class="sidebar-main">
            ...
            <div id="sidebar-menu">
                <ul class="sidebar-links " id="simple-bar">
                    ...
                    <li class="sidebar-list mb-2"><a class="sidebar-link sidebar-title link-nav text-white {{ request()->is('dashboard') ? 'active' : '' }}" href="{{ url('/dashboard') }}">
                            <span class="text-white"><i class="bi bi-house-door-fill"></i></span>
                            <span class="text-white">Dashboard</span></a>
                    </li>
                    <li class="sidebar-list"><a class="sidebar-link sidebar-title link-nav text-white {{ request()->routeIs('patient/index') ? 'active' : '' }}"
